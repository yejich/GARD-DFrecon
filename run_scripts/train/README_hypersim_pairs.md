...
```bash
bash run_scripts/JIHYE/train_GARD_da3_hypersim_20k.sh
```
...
bash run_scripts/JIHYE/train_GARD_da3_hypersim_20k.sh --max-steps 1 --fixed-views 4
# Dynamic N=1–4, same update/eval check:
bash run_scripts/JIHYE/train_GARD_da3_hypersim_20k.sh --max-steps 1
```
